...
\begin{figure*}[pos=!t,width=\textwidth]
\centering
\includegraphics[width=0.92\textwidth,height=0.72\textheight,keepaspectratio]{figures/ppo_process.pdf}
...
\includegraphics[width=0.31\textwidth]{figures/node3_error.png} &
\includegraphics[width=0.31\textwidth]{figures/node2_error.png} &
\includegraphics[width=0.31\textwidth]{figures/node1_error.png}
\end{tabular}
