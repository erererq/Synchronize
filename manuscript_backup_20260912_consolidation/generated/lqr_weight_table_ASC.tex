...
\caption{Effect of LQR control weighting on synchronization error and control energy. Each entry averages 20 test initial conditions; PPO additionally averages three independent training runs. The value $R=0.01$ is selected using separate validation initial conditions and kept fixed during testing. MAE covers the full simulation interval, including the impulse scenario.}
